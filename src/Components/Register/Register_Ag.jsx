    ...
    return (
        <div className="bg-[#5D0911] w-[90%] rounded-xl lg:w-[70%] mx-auto mt-5 p-5 md:p-10 lg:p-14">
            <div className="flex justify-between">
                ...
                <div>
                <Link  to='/register' className="btn">Register As User</Link>
                </div>
            </div>
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                <div className="space-y-2">
                    <div>
                        ...
                        <input type="text" placeholder="Enter your Name" className="w-full rounded-lg px-3 py-2 text-white border outline-none   bg-transparent  "
                            {...register("userName",{
                                required : true
                            })}
                        />
                    ...
                    <div>
                        ...
                        <input type="email" placeholder="Enter your email address" className="w-full px-3 py-2 border text-white outline-none rounded-lg border-gray-200 bg-transparent  "  {...register("userEmail",
                            {
                                required: true,
                                pattern: {
                    ...
                    <div>
                        ...
                        <input type="phone" placeholder="+880 1*********" className="w-full px-3 py-2 border text-white outline-none rounded-lg bg-transparent  " {...register("userPhone", {
                            required: true,
                            minLength: {
                                value: 11,
                ...
                <div className="space-y-2">
                    <div>
                        <button type="submit" className="bg-transparent w-full text-lg font-bold border   p-2 flex gap-1 rounded-lg items-center  text-white justify-center px-4 transition-all duration-1000 ">Register</button>
                    </div>
